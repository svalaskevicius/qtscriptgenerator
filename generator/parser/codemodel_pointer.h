...
public:
   ...
   // inline CodeModelPointer(const QAtomicPointer<T> &o) : QAtomicPointer<T>(o) { }
/*
    inline CodeModelPointer &operator=(const QAtomicPointer<T> &o) {
        QAtomicPointer<T>::operator=(o);
        return *this;
    }
   inline CodeModelPointer &operator=(T *o) {
        QAtomicPointer<T> other(o);
        QAtomicPointer<T>::operator=(other);
        return *this;
    }*/
    operator T * () const {
...
//    inline T *data() { return QAtomicPointer<T>::load(); }
 //   inline const T *data() const { return QAtomicPointer<T>::load(); }
   // inline const T *constData() const { return QAtomicPointer<T>::load(); }
